<div
    ...
    @custom-show-mark-as-spam-idea-modal.window="
        isOpen = true
                ...
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">Are you sure you want to mark this idea as spam? This action cannot be undone.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <button wire:click.prevent="markAsSpam" x-ref="confirmButton" type="button" class="inline-flex w-full justify-center rounded-md bg-blue px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-hover focus:bg-blue-hover sm:ml-3 sm:w-auto">Mark as Spam</button>
